...
A platform for creating and managing ideas with authentication.

✔ User authentication testing  
✔ CRUD operations for ideas  
✔ API endpoint validation  

👉 [View Project](ideacenter/README.md)

---

### 🍔 Foody API Tests
A food management system with full CRUD and search functionality.

✔ Food CRUD operations  
✔ Search functionality testing  
✔ Environment variables & authentication  

👉 [View Project](foody/README.md)
